                ...
                <div className={style["main__wrapper"]}>
                    <div className="container">
                        <form className={style["main__form"]} onSubmit={onClickSendUserApiLink}>
                            <input className={style["main__form-input"]} value={inputValue}
                                onChange={(e) => setInputValue(e.target.value)}
                                placeholder="Введите имя пользователя" type="text"/>
                            <button onClick={onClickSendUserApiLink} className={style["main__form-button"]}
                                type="submit">Найти
                            </button>
                            <button onClick={openInfoInConsole} className={style["main__form-button"]}
                                type="submit">Отобразить в консоли
                            </button>
                        </form>
                        {user.login ?
...
//TODO: Сделать сортировку по репозиториям, подписчикам, подпискам
// а также выводить список репозиториев пользователя. Оптимизировать код.
// Решить проблему с отображением данных при первом рендере.
